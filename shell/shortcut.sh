...
alias google-chrome-beta-wayland="/usr/bin/google-chrome-beta --gtk-version=4 --enable-feature=UseOzonPlatform --ozone-platform=wayland"
alias google-chrome-unstable-wayland="/usr/bin/google-chrome-unstable --gtk-version=4 --enable-feature=UseOzonPlatform --ozone-platform=wayland"
