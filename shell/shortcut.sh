...
alias apt-backup="cd ~/.dotfile/aur && ./backup-ubuntu.sh ./app-list-ubuntu.yaml"
alias apt-query="cd ~/.dotfile/aur && ./query-ubuntu.sh"
alias apt-update="sudo apt update && sudo apt upgrade"
alias apt-search="apt search"
alias snap-list="snap list"
alias flatpak-list="flatpak list"

# Keep original AUR aliases for reference (comment out on Ubuntu)
